                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs" v-if="productDetails.galleries.length > 0">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    ...
                                    <div v-for="ss in productDetails.galleries" :key="ss.id" class="pt" @click="changeImage(ss.photo)" :class="ss.photo == image_default ? 'active' : ''">
...
export default {
  ...
  components: {
    ...
    carousel
      ...
      setDataPicture(data) {
          // replace object productDetails dengan data from API
          this.productDetails = data;
          // replace value image default dengan data from API(galleries)
